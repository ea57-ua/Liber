            ...
            <div class="portfolio-isotope" data-portfolio-filter="*" data-portfolio-layout="masonry" data-portfolio-sort="original-order" data-aos="fade-up" data-aos-delay="100">
                ...
                <div class="row gy-4 portfolio-container">
                    ...
                    <div class="col-xl-4 col-md-6 portfolio-item filter-branding">
                        <div class="portfolio-wrap">
                            <a href="{{ asset('img/portfolio/branding-1.jpg') }}"
                               data-gallery="portfolio-gallery-app" class="glightbox">
                                <img src="{{ asset('img/portfolio/branding-1.jpg') }}"
                    ...
                    <div class="col-xl-4 col-md-6 portfolio-item filter-books">
                        <div class="portfolio-wrap">
                            <a href="{{asset('img/portfolio/book-1.jpg')}}" data-gallery="portfolio-gallery-app" class="glightbox"><img src="{{asset('img/portfolio/books-1.jpg')}}" class="img-fluid" alt=""></a>
                            <div class="portfolio-info">
            ...
            <div class="row gy-4">
                ...
                <div class="col-xl-4 col-md-6">
                    <article>
                        ...
                        <div class="post-img">
                            <img src="{{asset('img/portfolio/product-1.jpg')}}" alt="" class="img-fluid">
                        </div>
                        ...
                        <div class="d-flex align-items-center">
                            <img src="{{asset('img/clients/client-1.png')}}" alt="" class="img-fluid post-author-img flex-shrink-0">
                            <div class="post-meta">
